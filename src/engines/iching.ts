...
const HEX_KEYWORDS: Record<number, string> = {
  1:'Crée',2:'Accueille',3:'Persévère',4:'Apprends',5:'Patiente',
  6:'Négocie',7:'Organise',8:'Unis-toi',9:'Discipline',10:'Avance',
  11:'Harmonise',12:'Attends',13:'Rassemble',14:'Partage',15:'Sois humble',
  16:'Inspire',17:'Suis le flux',18:'Corrige',19:'Approche',20:'Observe',
  21:'Tranche',22:'Embellissez',23:'Lâche prise',24:'Recommence',25:'Sois pur',
  26:'Accumule',27:'Nourris-toi',28:'Ose',29:'Plonge',30:'Éclaire',
  31:'Ressens',32:'Persiste',33:'Recule',34:'Fonce',35:'Progresse',
  36:'Protège-toi',37:'Réunis',38:'Accepte',39:'Contourne',40:'Libère',
  41:'Sacrifiez',42:'Reçois',43:'Décide',44:'Rencontre',45:'Rassemble',
  46:'Monte',47:'Endure',48:'Puise',49:'Transformez',50:'Cultive',
  51:'Secoue',52:'Arrête-toi',53:'Grandis',54:'Adapte-toi',55:'Rayonne',
  56:'Explore',57:'Pénètre',58:'Réjouis-toi',59:'Dissous',60:'Limite',
  61:'Fais confiance',62:'Prudence',63:'Célèbre',64:'Prépare'
};
...
export function getHexProfile(hexNum: number): HexProfile {
  return HEX_PROFILES[hexNum] || {
    ...
    opportunity: 'Observation stratégique.', action: 'Observe et attends le bon moment.',
...
export function calcIChing(bd: string, today: string): IChingReading {
  ...
  // Méthode Kaironaute (inspirée Mei Hua Yi Shu de Shao Yong, 1012-1077)
  // Ce n'est PAS du Mei Hua canonique : personalDay (numérologie) injecté + YANG_BIAS 68%
  // Ronde 2026-03-21 Q1 : unanime 3/3 — renommer, garder YANG_BIAS pour rétrocompatibilité
  // upperSum = signal du jour (pday = nombre personnel → personnalisé par naissance)
  // lowerSum = upperSum + 12 (heure midi fixe — choix stabilité quotidienne)
  // YANG_BIAS legacy V2.6+ (validé Grok R2/R3) — ne pas supprimer sans re-simulation
...
const MUTANT_LINE_1: Record<number, string> = {
  ...
  11: 'L\'harmonie commence par le bas. Renforce tes fondations avant de bâtir plus haut.',
  14: 'Richesse encore cachée. Protège tes ressources — la discrétion est la gardienne de l\'abondance.',
  ...
  50: 'Chaudron froid. Purifie tes intentions avant de nourrir ton projet — la qualité des ingrédients détermine le résultat.',
  ...
  7:  'L\'armée commence par l\'ordre. Avant d\'avancer, assure la discipline de tes troupes et la clarté de ton objectif.',
  13: 'L\'union commence par l\'égalité. Traite tes partenaires comme des égaux — c\'est là que naît la force collective.',
  17: 'Pour être suivi, suis d\'abord. Montre l\'exemple avec humilité — les autres te suivront naturellement.',
  25: 'La pureté d\'intention est ton arme la plus puissante. Agis sans calcul, avec sincérité — le ciel répondra.',
...
const MUTANT_LINE_2: Record<number, string> = {
  ...
  1:  'Le dragon apparaît dans le champ. Montre-toi avec confiance — le moment de la visibilité arrive.',
  11: 'Le sage traverse le fleuve. Avance avec détermination malgré les courants contraires.',
  14: 'Un grand chariot porte la charge. Accepte la responsabilité — ta capacité à porter est immense.',
  34: 'La puissance trouve son axe. Centre ta force avant de frapper — la précision multiplie l\'impact.',
  ...
  50: 'Le chaudron est rempli. Nourris ton projet avec les bons ingrédients — qualité prime sur quantité.',
  55: 'L\'abondance attire le regard. Protège ta richesse des envieux — le succès visible demande discrétion.',
  // B-tier — Line 2 "Service"
  2:  'L\'ouverture devient stratégique. Accueille avec discernement — tout ne mérite pas ton énergie.',
  7:  'Le général est au centre de l\'armée. Ta position de force vient de ta proximité avec le terrain.',
...
const MUTANT_LINE_3: Record<number, string> = {
  ...
  11: 'Pas de plaine sans pente. Au milieu de l\'harmonie, prépare-toi au retournement inévitable.',
  14: 'Le prince offre au fils du ciel. Partage ton abondance avec les puissants — la générosité stratégique protège.',
