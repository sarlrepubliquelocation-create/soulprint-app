...
const HEX_KEYWORDS: Record<number, string> = {
  ...
  21:'Tranche',22:'Embellis',23:'Lâche prise',24:'Recommence',25:'Sois pur',
  ...
  41:'Sacrifie',42:'Reçois',43:'Décide',44:'Rencontre',45:'Rassemble',
  46:'Monte',47:'Endure',48:'Puise',49:'Transforme',50:'Cultive',
...
const HEX_TIERS: Record<number, HexTier> = {
  ...
  4: 'D',   // Folie juvénile
  5: 'D',   // Attente — tension d'attente, moment critique (Grok R2)
  6: 'D',   // Conflit
  9: 'D',   // Petit Domestique — petits obstacles, patience forcée (Grok R2)
  18: 'D',  // Travail sur le corrompu
  19: 'D',  // Approche — tension du moment (Grok: "trop tôt ou trop tard", pas favorable)
...
const MUTANT_LINE_1: Record<number, string> = {
  ...
  43: 'Décision prise mais pas encore visible. Agis avec discrétion — le moment de l\'annonce compte autant que la décision.',
