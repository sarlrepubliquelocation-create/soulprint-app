...
export const NAKSHATRAS: NakshatraData[] = [
  ...
  },
  {
    ...
    keyTrait: "Transformation par le défi",
  ...
  },
  {
    ...
    shadowAspect: 'Intensité à canaliser',
    coreText: "Ardra porte l'énergie de la tempête qui nettoie — l'intensité qui précède la transformation. Ces jours peuvent apporter des remises en question, des prises de conscience fortes ou des tournants nécessaires. L'énergie est puissante et difficile à diriger pour les domaines doux (amour, relations), mais excellente pour débloquer ce qui stagne.",
    globalBaseScore: -1,
  ...
  },
  {
    ...
    coreText: "Magha est le Nakshatra des ancêtres et de l'autorité royale. Il y a en toi une conscience de ton lignée, de ce que tu as hérité et de ce que tu transmettres. Ce jour amplifie les questions d'autorité, de statut et d'héritage. Favorable aux Affaires, difficile pour l'humilité.",
    globalBaseScore: 0,
  ...
  },
  {
    ...
    keyTrait: 'Courage, protection, autorité',
  ...
  },
  {
    ...
    archetype: 'Le Libérateur',
    keyTrait: 'Remise en question profonde, vérité nue',
    shadowAspect: 'Déconstruction sans reconstruction',
    coreText: "Mula va à la racine des choses — ces jours portent une énergie de remise en question profonde. Ce qui ne tient plus est naturellement relâché. Intense pour les domaines relationnels, mais puissant pour la recherche de vérité et la transformation intérieure.",
    globalBaseScore: -1,
  ...
  },
  {
    ...
    shadowAspect: 'Inertie et repli intérieur',
    coreText: "UttaraBhadrapada apporte la sagesse qui suit l'ardeur — la profondeur sereine, la compassion gagnée par l'expérience. Saturne donne ici sa face la plus haute : la maturité spirituelle. Ces jours favorisent la résolution de schémas anciens et les décisions prises avec recul.",
    globalBaseScore: 1,
