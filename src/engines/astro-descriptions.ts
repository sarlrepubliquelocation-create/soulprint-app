// ═══ ASTRO DESCRIPTIONS ═══
// 10 planètes × 12 signes — descriptions stratégiques (Portrait Astral)
...
export const PLANET_DESC: Record<string, Record<string, string>> = {
  ...
  sun: {
    Aries:       "Énergie pionnière. Tu inities, tu fonces — l'attente n'est pas dans ton ADN. Autorité instinctive, besoin d'autonomie totale.",
    ...
    Virgo:       "Précision analytique et sens du détail. Tu optimises les systèmes, identifies les failles. L'excellence est ton standard.",
    ...
    Aquarius:    "Innovateur et indépendant. Tu penses hors cadre, bouscules les conventions et portes les idées d'avenir.",
  ...
  moon: {
    ...
    Capricorn:   "Contrôle émotionnel rigoureux. Tu compartimentes et avances. Tendance à porter seul — force et solitude stratégique.",
  ...
  mercury: {
    Aries:       "Pensée directe et rapide. Tu communiques sans filtre, va droit au but. Bon pour les présentations courtes et les décisions flash.",
    Taurus:      "Réflexion méthodique et pragmatique. Tu ne te précipites jamais — chaque idée est pesée, testée, validée.",
    Gemini:      "Mental brillant et versatile. Tu jongles entre les sujets, connecte les idées entre elles. Communication naturelle et persuasive.",
    ...
    Leo:         "Expression charismatique et créative. Tu communiques avec autorité et générosité. Conteur-né, tu captives naturellement.",
    Virgo:       "Analyse chirurgicale et pensée systématique. Tu décortiques, classes, optimises. Excellent en audit, comptes-rendus et méthode.",
    Libra:       "Communication diplomatique et équilibrée. Tu pèses chaque mot, cherches le consensus. Bon négociateur et médiateur.",
    ...
    Capricorn:   "Mental structuré et pragmatique. Tu penses en termes de résultats, d'efficacité et de rentabilité. Communication factuelle.",
  ...
  venus: {
    Aries:       "Attraction directe et conquérante. Tu fonces dans les relations comme en affaires — franc, passionné, impatient.",
    ...
    Capricorn:   "Relations construites dans la durée. Tu valorises la fiabilité et le sérieux. Investissements conservateurs et rentables.",
  ...
  // ♂ MARS — action, énergie, détermination, gestion de conflit
  mars: {
    ...
    Leo:         "Action théâtrale et courageuse. Tu mènes les charges, prends les risques visibles. Tu diriges par l'exemple.",
    ...
    Scorpio:     "Puissance stratégique intense. Tu agis en profondeur, planifies dans l'ombre. Capacité de transformation radicale.",
  ...
  jupiter: {
    Aries:       "Expansion par l'initiative et l'audace. La chance te sourit quand tu oses. Croissance rapide et pionnière.",
    ...
    Leo:         "Expansion par le charisme et la créativité. Les grands projets visibles sont favorisés. Chance dans le spectacle et la direction.",
  ...
  saturn: {
    ...
    Taurus:      "Défis autour de la sécurité matérielle. Tu construis une solidité financière indestructible par le travail et la rigueur.",
    Gemini:      "Structure de la pensée et de la communication. Tu apprends la profondeur au détriment de la superficialité.",
    Cancer:      "Leçons émotionnelles et familiales. Tu construis une base solide, parfois après des défis d'attachement.",
    Leo:         "Leçon d'humilité dans l'exercice du pouvoir. Tu gagnes l'autorité véritable par la compétence, pas par le titre.",
  ...
  uranus: {
    Aries:       "Révolutions personnelles et autorité novatrice. Besoin viscéral de liberté d'action. Innovation par le courage.",
    Taurus:      "Bouleversement des valeurs et des finances. Nouvelles formes de richesse et de stabilité. Technologie au service du concret.",
    ...
    Leo:         "Créativité radicale et expression individuelle unique. Rupture dans les arts, le spectacle et l'exercice du pouvoir.",
    Virgo:       "Innovation dans le travail et la santé. Nouvelles méthodes, technologies appliquées, optimisation radicale.",
    Libra:       "Révolution relationnelle et sociale. Nouvelles formes de partenariat, justice sociale, esthétique d'avant-garde.",
    Scorpio:     "Transformation radicale et profonde. Renversement des pouvoirs établis, révélation des secrets, renaissance.",
    Sagittarius: "Innovation philosophique et éducative. Remise en question des croyances, exploration de frontières inédites.",
    Capricorn:   "Révolution des structures et institutions. Renversement de l'autorité traditionnelle, nouvelles formes de gouvernance.",
  ...
  neptune: {
    Aries:       "Inspiration dans l'action et la prise de direction. Idéalisme pionnier, mais attention aux élans irréfléchis motivés par des illusions.",
  ...
  pluto: {
    Aries:       "Pouvoir brut et transformation par l'action. Tu renais en agissant. Force de rupture personnelle intense.",
    ...
    Leo:         "Pouvoir créatif et magnétique. Transformation par l'expression de soi. Autorité naturelle qui catalyse le changement.",
